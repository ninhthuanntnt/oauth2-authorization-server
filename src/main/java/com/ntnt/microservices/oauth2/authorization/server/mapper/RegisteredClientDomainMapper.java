...
@Component
public class RegisteredClientDomainMapper {
  private final ObjectMapper objectMapper;

  public RegisteredClientDomainMapper() {
  ...
  public RegisteredClient toObject(RegisteredClientDomain client) {
  ...
  public RegisteredClientDomain toEntity(RegisteredClient registeredClient) {
    ...
    RegisteredClientDomain entity = new RegisteredClientDomain();
